...
import { Building2, Microscope, FlaskConical, MapPin, Factory, Rocket, ArrowRight } from 'lucide-react';
...
const Timeline = () => {
  ...
  const milestones = [
    ...
    {
      title: t('about', 'milestone4'),
      description: t('about', 'milestone4Desc'),
      icon: <MapPin className="h-6 w-6 text-white" />,
      year: '2025.06',
      color: 'from-orange-500 to-amber-400'
    },
    {
      title: t('about', 'milestone5'),
      description: t('about', 'milestone5Desc'),
      icon: <Factory className="h-6 w-6 text-white" />,
      year: '2025.08',
      color: 'from-indigo-500 to-purple-400'
    },
    {
      title: t('about', 'milestone6'),
      description: t('about', 'milestone6Desc'),
  ...
  return (
    <div className="space-y-16 relative">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">{t('about', 'milestonesTitle')}</h2>
        <motion.div
      ...
      <div className="relative max-w-5xl mx-auto py-10">
        ...
        {milestones.map((milestone, index) => (
          ...
          >
            ...
            {/* 内容 */}
            <div className={`w-full pl-16 md:pl-0 md:w-1/2 ${index % 2 === 0 ? 'md:pr-16 md:text-right' : 'md:pl-16 text-left'} box-border`}>
              <motion.div
              ...
              >
                ...
                <div className={`mt-6 flex items-center text-primary font-medium opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-0 ${index % 2 === 0 ? 'md:justify-end translate-x-4' : '-translate-x-4'}`}>
                  <span>{t('about', 'milestonesLearnMore')}</span>
