...
import DMTProduct from '@/components/products/DMTProduct';
import EGProduct from '@/components/products/EGProduct';
import ApplicationGrid from '@/components/products/ApplicationGrid';
...
import QualityCertification from '@/components/products/QualityCertification';
...
export default function ProductsPageClient() {
  ...
  const tabs = [
    { id: 'dmt', label: t('products', 'dmtTab') },
    { id: 'eg', label: t('products', 'egTab') },
    { id: 'applications', label: t('products', 'applicationsTab') },
  ];
