...
import Timeline from '@/components/technology/Timeline';
import RDStrength from '@/components/technology/RDStrength';
  ...
  return (
      <div className="min-h-screen bg-gray-50/30">
        ...
        <section className="py-24 bg-white relative overflow-hidden">
          {/* 背景装饰 */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-64 h-64 bg-primary/5 rounded-full blur-3xl pointer-events-none"></div>
